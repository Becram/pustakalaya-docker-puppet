class pustakalaya::run{
       ...
       docker::run { 'pgmaster':
              image   => 'becram/olen-elib-db-master:v5.1.0',
              net     => 'net-pusta',
       ...
       docker::run { 'elastic':
              image   => 'becram/olen-elib-elastic:v5.1.0',
              restart =>  'always',
              service_prefix  => 'docker-',
              net     => 'net-pusta',
              depends => [ 'pgmaster' ],
       ...
       docker::run { 'pgslave':
              image   => 'becram/olen-elib-db-slave:v5.1.0',
              restart =>  'always',
              service_prefix  => 'docker-',
       ...
       docker::run { 'celery':
              image   => 'becram/olen-elib-celery:v5.1.0',
              restart =>  'always',
              service_prefix  => 'docker-',
              net     => 'net-pusta',
       ...
       docker::run { 'code':
              image   => 'becram/olen-elib-code:v5.1.0',
              restart =>  'always',
       ...
       docker::run { 'nginx':
              image   => 'becram/olen-elib-nginx:v5.1.0',
              restart =>  'always',
              ports => ["80:8000"],
              volumes => ['/library/media_root:/library/media_root:rw', '/library/static_root:/library/static_root:rw'],
              service_prefix  => 'docker-',
